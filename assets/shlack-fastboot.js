define('~fastboot/app-factory', ['shlack/app', 'shlack/config/environment'], function(App, config) {
  App = App['default'];
...
define("shlack/initializers/ajax", ["exports"], function (_exports) {
  "use strict";
...
define("shlack/initializers/error-handler", ["exports"], function (_exports) {
  "use strict";
...
define("shlack/instance-initializers/setup-fetch", ["exports", "fetch"], function (_exports, _fetch) {
  "use strict";
  ...
  _exports.default = _default;
});//# sourceMappingURL=shlack-fastboot.map
